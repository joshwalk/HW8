...
for tw in umsi_tweets:
    ...
    cur.execute('INSERT INTO Tweets (tweet_id, author, time_posted, tweet_text retweens) VALUES (?, ?, ?, ?, ?)', tup)
...
# Select all the tweets (thefull rows/tuples of information) that have been retweeted MORE than 2 times, and fetch them into the variable
